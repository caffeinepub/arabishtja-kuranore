      ...
      <Dialog open={showWordDialog} onOpenChange={setShowWordDialog}>
        <DialogContent className="max-w-2xl max-h-[90vh]">
          ...
          <DialogFooter>
            ...
            <Button onClick={handleSaveWord} disabled={addWordToLesson.isPending}>
              {addWordToLesson.isPending ? 'Duke ruajtur...' : 'Ruaj'}
            </Button>
          </DialogFooter>
        </DialogContent>
      </Dialog>
      ...
      <Dialog open={showAyahDialog} onOpenChange={setShowAyahDialog}>
        <DialogContent className="max-w-2xl">
          ...
          <DialogFooter>
            ...
            <Button onClick={handleSaveAyah} disabled={addAyahToLesson.isPending || updateLessonAyah.isPending}>
              {(addAyahToLesson.isPending || updateLessonAyah.isPending) ? 'Duke ruajtur...' : 'Ruaj'}
            </Button>
          </DialogFooter>
        </DialogContent>
      </Dialog>
        ...
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              Kjo veprim do të fshijë fjalën "{wordToDelete?.word}" nga ky mësim. Nëse fjala nuk përdoret në asnjë mësim tjetër, ajo do të fshihet plotësisht nga fjalori.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
            <AlertDialogCancel onClick={() => setWordToDelete(null)}>Anulo</AlertDialogCancel>
            <AlertDialogAction onClick={handleConfirmDeleteWord} className="bg-destructive text-destructive-foreground hover:bg-destructive/90">
              Fshi
            </AlertDialogAction>
          </AlertDialogFooter>
        </AlertDialogContent>
